...
if($_SESSION['authenticated'] != 'PCY492My6U8arf') {
	...
	echo '
	<form method="post" action="ngo.php?'.$_SERVER['QUERY_STRING'].'">
...
if(!isset($_GET['edit'])){
	...
	if(isset($_GET['insufficient'])){
		...
		$status = '3';
		$link = 'http://4636.ushahidi.com/ngo.php?insufficient=1&reintroduce=';
...
if(isset($_GET['edit'])){
	$title = 'EDIT QUEUE';
	$status = '2';
	$link = 'http://4636.ushahidi.com/ngo.php?edit=1&editform=';
	$link_text = 'Edit';
	...
	if(isset($_GET['editform'])){
		...
		?>
		<form method="POST" action="ngo.php?edit=1&editpost=1">
