    ...
    <div id="content">
            ...
            <table>
                ...
                <tr style="background-color:#E2B1B1;">
                    ...
                    <A href="http://www.openstreetmap.org/?lat=18.96&lon=-72.81&zoom=8&layers=B000FTF" targe="_blank">Open Street Map</A>
                    <br>Many of the locations are in more etail here.
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo $sms_message['message']; ?>
                        <input type="hidden" id="sms" name="sms" value="<?php echo $sms_message['message']; ?>" />
