...
PdMarker.prototype.resetDetailWinClass = function() {
	...
	//this.setDetailWinClass("markerTooltip");
}
...
PdMarker.prototype.showDetailWin = function() {
	...
	var html = "<table width=100% cellspacing=0 cellpadding=0><tr><td>" + this.detailWinHTML + "<\/td><td align=right valign='top'><a class='markerDetailClose' href='javascript:PdMarkerClose(" + this.internalId + ")'><img src='http://www.google.com/mapfiles/close.gif' border=0 width='14' height='13'><\/a><\/td><\/tr><\/table>";
